...
std::optional<std::tuple<int, int>> TetrisRotateChecker::CheckRotation(
    const Tetromino& tetromino, const int rot_idx, int tetromino_x,
    int tetromino_y, const bool left_rotate) const {
...
TetrisRotateChecker::InitializeLeftOffset() const {
  ...
  // Normal のオフセット.
  result[{RotationType::kNone, 0}] = {{0, 0}, {1, 0}, {1, 1}, {0, -2}, {1, -2}};
  result[{RotationType::kNone, 1}] = {
      {0, 0}, {-1, 0}, {-1, -1}, {0, 2}, {-1, 2}};
  result[{RotationType::kNone, 2}] = {
      {0, 0}, {-1, 0}, {-1, 1}, {0, -2}, {-1, -2}};
  result[{RotationType::kNone, 3}] = {{0, 0}, {1, 0}, {1, -1}, {0, 2}, {1, 2}};
